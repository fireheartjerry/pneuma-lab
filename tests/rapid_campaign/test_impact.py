...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            "C2",
            False,
            {"provider_binding", "package", "authorization"},
        ),
        (
            {"model", "packet"},
            "C3",
            False,
            {"input_seals", "images", "sboms", "run_spec", "package", "authorization"},
        ),
        (
            {"sample_size"},
            "C4",
...
def test_change_classes_are_minimal_and_power_is_c4_only(
    domains, level, power, required
) -> None:
