"""Provider authority fixture adapted to study-seal integration."""
...
class ProviderStudySealFixture:
    run_root: Path
    seal: Callable[[], ArtifactRef]
    nested_refs: tuple[Mapping[str, object], ...]
...
def build_provider_study_fixture(
    tmp_path: Path,
    *,
    ...
    return ProviderStudySealFixture(
        run_root=run_root,
        seal=seal,
        nested_refs=(
            subject_ref,
...
__all__ = ("ProviderStudySealFixture", "build_provider_study_fixture")
