...
def protocol() -> dict:
    return {"rungs": list(RUNG_NAMES), "max_cost_usd": 1.0, "max_runtime_minutes": 10, "max_retries": 1, "max_samples": 2, "minimum_p10_output_tokens_per_second": MINIMUM_P10_OUTPUT_TOKENS_PER_SECOND}
