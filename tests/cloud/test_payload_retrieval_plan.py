...
def test_candidate_is_exact_bounded_and_authorizes_nothing() -> None:
    plan = build_payload_retrieval_plan(_manifest(), executor_sources_sha256="b" * 64)
...
def test_committed_ready_plan_binds_the_exact_executor_surface() -> None:
...
def test_ready_state_requires_a_pricing_receipt() -> None:
    plan = build_payload_retrieval_plan(_manifest(), executor_sources_sha256="b" * 64, pricing_receipt_sha256="a" * 64)
