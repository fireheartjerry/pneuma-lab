...
from pneuma_lab.cloud.payload_retrieval_plan import build_payload_retrieval_plan, payload_retrieval_plan_digest
...
def main() -> int:
    ...
    plan = build_payload_retrieval_plan(manifest, pricing_receipt_sha256=args.pricing_receipt_sha256)
