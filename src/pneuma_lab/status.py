...
_CURRENT_SYSTEM_STATE = {
    ...
    "neurips_resampling_null_task10": ("partial", "offline_research"),
    ...
    "neurips_resampling_null_receipt_portability": ("implemented", "offline_research"),
    "neurips_resampling_null_step6_aws_architecture": ("partial", "offline_research"),
    "neurips_resampling_null_official_execution_path": ("partial", "offline_research"),
    ...
    "neurips_resampling_null_step10_security_controls": ("partial", "offline_research"),
    "neurips_resampling_null_step11_emulation": ("partial", "offline_research"),
    "neurips_resampling_null_step12_deployment_preflight": ("partial", "offline_research"),
    "neurips_resampling_null_step13_pilot_protocol": ("partial", "offline_research"),
    "neurips_resampling_null_phase_b_preparation": ("partial", "offline_research"),
}
