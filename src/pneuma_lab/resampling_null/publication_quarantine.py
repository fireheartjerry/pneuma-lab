...
RollbackResidual = str | UnlocatedOwnedIdentity
...
def _rebind_expected_quarantine(
    *,
    ...
    try:
        ...
        close_source(rebound_descriptor)
        raise
    close_source(source_descriptor)
